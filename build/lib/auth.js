...
class AuthManager {
    constructor(log, onTokensUpdated) {
        this.log = log;
        this.onTokensUpdated = onTokensUpdated;
        this.accessToken = '';
        this.refreshToken = '';
        this.tokenExpiry = 0; // unix ms
    }
    ...
    async exchangeCode(code, verifier) {
        ...
        try {
            ...
            const msg = axios_1.default.isAxiosError(err) ? JSON.stringify((_a = err.response) === null || _a === void 0 ? void 0 : _a.data) : String(err);
    ...
    async getValidToken() {
        ...
        if (!this.accessToken)
            throw new Error('Not authenticated. Please provide authorization code.');
